...
from tasks import update_library
...
def add_new_book():
    ...
    with Session() as sess:
        try:
            ...
            # update library
            action_payload = BookActions().add_book(payload)
            print(payload, action_payload)
            update_library(action_payload)
...
def delete_book(book_id):
    with Session() as sess:
        ...
        # update library
        action_payload = BookActions(book_id).delete_book()
        print("TASK ID: ", update_library(action_payload))
